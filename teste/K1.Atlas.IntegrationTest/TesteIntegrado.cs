...
public class TesteIntegrado : IAsyncLifetime
{
    ...
    [Fact]
    public async Task DeveRetornarNFSeComContribuinteComNumDocReceita123456()
    {
        ...
        var nfse = await response.Content.ReadFromJsonAsync<NFSe>();
        Assert.Equal("123456", nfse?.Contribuinte.NumDocReceita);
    }
